...
Repeat for previous years of data: only records for the two clones are in 2020

```{r}
just_clone <- dogwood_obs %>% filter(individual_id %in% c(229765, 250718))
range(just_clone$observation_date)
```
